...
public class StockCardViewsFirstCommand implements ICommand {
	...
	public StockCardViewsFirstCommand(StockCardFrame stockcardframe) {
		super();
	...
	public void execute() {
		...
		String hql = "select * from stockcard1 where id = (select min(id) from stockcard1 where id < '"+id+"')";
