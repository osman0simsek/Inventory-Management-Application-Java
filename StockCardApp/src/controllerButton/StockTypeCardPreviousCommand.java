...
public class StockTypeCardPreviousCommand implements ICommand {
	...
	public StockTypeCardPreviousCommand(StockTypeCardFrame stocktypecardframe) {
		super();
		this.stocktypecardframe = stocktypecardframe;
	}
	@Override
	public void execute() {
		...
		String hql ="select * from stocktype where id = (select max(id) from stocktype where id > '"+id+"')";
