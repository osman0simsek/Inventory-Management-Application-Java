...
public class KdvTypeCardPreviousCommand implements ICommand {
	...
	public KdvTypeCardPreviousCommand(KdvTypeCardFrame kdvtypecardframe) {
		super();
	...
	public void execute() {
		...
		String hql ="select * from kdvtype where id = (select max(id) from kdvtype where id < '"+id+"')";
